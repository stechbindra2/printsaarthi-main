...
const AlphaMarquee = () => {
    ...
    return (
        <>
            {isVisible && (
                <div className="fixed top-0 left-0 right-0 z-[100] bg-gradient-to-r from-[#622AD1] via-[#7c4ddb] to-[#F89816] shadow-lg">
                        ...
                        <div className="flex items-center justify-center space-x-8">
                            ...
                            <div className="flex items-center space-x-8 animate-marquee whitespace-nowrap">
                                ...
                                <div className="flex items-center space-x-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30">
                                    ...
                                    <span className="text-white font-semibold text-sm md:text-base">Alpha Testing</span>
                                </div>

                                {/* Link Text */}
                                <span className="text-white font-medium text-sm md:text-base">→</span>

                                <Link href="https://delivery1-printrocket.vercel.app/" target="_blank" rel="noopener noreferrer">
                                    <span className="text-white font-semibold text-sm md:text-base hover:text-yellow-200 transition-colors duration-300 cursor-pointer">
            ...
            {isVisible && <div className="h-16 md:h-14"></div>}
