...
const AlphaMarquee = () => {
    ...
    return (
        <>
            <div className="w-full bg-gradient-to-r from-[#622AD1] via-[#7c4ddb] to-[#F89816] shadow-lg relative">
                {/* Main Marquee Container */}
                <div className="relative overflow-hidden py-3 px-16">
                    ...
                    <button
                        ...
                        className="absolute right-4 top-1/2 transform -translate-y-1/2 text-white hover:text-yellow-200 transition-colors duration-300"
