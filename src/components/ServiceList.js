            ...
            <div className="backdrop-blur-lg bg-white/98 border border-gray-200/80 rounded-3xl shadow-2xl p-6 md:p-8 animate-in slide-in-from-top-2 duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
                    {servicesData.slice(0, 5).map((category, index) => (
                        <div 
                            key={index} 
                            className="group hover:bg-gradient-to-br hover:from-purple-50 hover:to-orange-50 rounded-2xl p-4 transition-all duration-300 border border-transparent hover:border-blue-100 hover:shadow-md"
                        >
                ...
                <div className="mt-8 pt-6 border-t border-gray-100">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <Link href="https://wa.me/message/W22H3ZBHYRG4H1">
                            <button className="inline-flex items-center space-x-2 bg-gradient-to-r from-[#622AD1] to-[#7c4ddb] hover:from-[#F89816] hover:to-[#ffad3c] px-6 py-3 rounded-xl font-semibold text-sm text-white transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
